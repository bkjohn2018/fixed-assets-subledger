...
Scaffolded in `powerbi/CapExLifecycle.Report` (`.pbip`).

## Page order

| # | Display name | Internal name | Audience |
|---|--------------|---------------|----------|
| 1 | Overview | `fa2233445566778899aa` | CapEx Lifecycle landing |
...
Wire the semantic model (`CapExLifecycle.SemanticModel`) with:

- `F_AP_Aging_Schedule` partition from `powerbi/queries/ap/F_AP_Aging_Schedule.m`
- `F_AP_Invoice_Distribution` from `powerbi/queries/ap/F_AP_Invoice_Distribution.m`
