SELECT
  ...
  "Asset Transaction Amounts"."Cost Delta"     AS COST_DELTA,
  "Asset Transaction Amounts"."Depreciation Reserve Delta" AS DEPRN_RESERVE_DELTA,
  "Asset Transaction Amounts"."Proceeds"       AS PROCEEDS,
  "Asset Transaction Amounts"."Gain or Loss"   AS GAIN_LOSS,
  "Asset Transaction Amounts"."Units Delta"    AS UNITS_DELTA,
